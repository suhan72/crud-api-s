function storage(event){
    ...
    axios.post("https://crudcrud.com/api/1d8ff6aca62444baaeb1787e744d1056/appoinmentdata",obj)
    .then((response) =>{
...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    axios.get("https://crudcrud.com/api/1d8ff6aca62444baaeb1787e744d1056/appoinmentdata")
    .then((response)=>{
        console.log(response)
...
function deleteuser(userId){
    ...
    axios.delete(`https://crudcrud.com/api/1d8ff6aca62444baaeb1787e744d1056/appoinmentdata/${userId}`)
    .then((response)=>{
